    ...
    public class Robot : Unit
    {
       ...
       //public int health = 1000;
        ...
        private void drawUnderFireAnimation()
        {
            ...
            //    }
            //    else if (!selected && FiringFrame < 2)
            //    {
            //        ION.spriteBatch.Draw(Images.unit_shooting[owner - 1, (int)facing, FiringFrame], new Rectangle((int)(((pos.X - ION.halfWidth) * (scale / 15.0f)) + ION.halfWidth + (x)), (int)(((pos.Y) * (scale / 15.0f)) + (y) + (baseHalfHeight * 2)), (int)(baseHalfWidth * 2), (int)(baseHalfHeight * 4)), Color.White);
            //    }
